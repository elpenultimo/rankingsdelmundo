...
import { isRankingRegion, isRankingYear } from "../../../../../../../data/taxonomy";
...
export default function OpenGraphImage({
  ...
  const title = ranking && isValidRegion && isValidYear
    ? `${ranking.title} — ${regionLabel} — ${params.year}`
    : "Vista no disponible";
  const subtitle = ranking && isValidRegion && isValidYear
    ? `Top 20 • ${regionLabel} • Actualizado ${params.year} • Índices referenciales`
