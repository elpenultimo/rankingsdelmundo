...
import { getComparableMetricsForCity } from "../../../../lib/compare";
...
export const generateMetadata = ({ params }: { params: { slug: string } }): Metadata => {
  ...
  const canonical = buildCompareDetailPath("ciudad", entityA.slug, entityB.slug);
  return {
...
export default function EmbedCityComparePage({
  params,
  searchParams
}: {
  params: { slug: string };
  ...
  return (
    <div className="px-4 py-6">
      ...
      <EmbedCompare
        ...
        rows={rows}
        variant={variant}
        compareUrl={buildCompareDetailPath("ciudad", entityA.slug, entityB.slug)}
      />
    </div>
  );
}
